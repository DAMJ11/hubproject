            ...
            {postImages.map((image, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-2">{t(`posts.${index}.date`)}</p>
                  <h3 className="text-xl font-bold text-brand-900 mb-2 line-clamp-2">
                    {t(`posts.${index}.title`)}
                  </h3>
                  <p className="text-gray-600 dark:text-gray-400 mb-4 line-clamp-2">{t(`posts.${index}.excerpt`)}</p>
                  <Link href="#">
                    <Button
                      variant="outline"
