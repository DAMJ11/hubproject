                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white flex items-center gap-2">
                      {cert.name}
                      {cert.is_verified && (
                        <span className="text-xs px-2 py-0.5 rounded-full bg-green-100 text-green-700">{t("verified")}</span>
                      )}
                      {cert.is_expired && (
                        <span className="text-xs px-2 py-0.5 rounded-full bg-red-100 text-red-700">{t("expired")}</span>
                      )}
                    </h3>
