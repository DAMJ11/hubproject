      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <AuthTransition className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            >
              <Image
                src="https://ext.same-assets.com/1985226505/3863342314.svg"
                alt="Google"
                width={28}
                height={28}
                className="w-7 h-7"
              />
              <span className="text-sm font-medium text-gray-700 underline">Iniciar sesión con Google</span>
            </motion.button>

            {/* Register Link */}
            <StaggeredTransition delay={0.4}>
              <div className="text-center pt-2">
                <p className="text-sm text-gray-700 font-semibold">¿No tienes una cuenta?</p>
        ...
        <StaggeredTransition delay={0.6}>
          ...
          <div className="flex items-center gap-2 bg-white rounded-lg px-3 py-1.5 border border-gray-200">
            <Image
              src="https://ext.same-assets.com/1985226505/4247906746.svg"
              alt="Language"
              width={28}
              height={14}
              className="w-7"
          ...
          <button className="flex items-center gap-1.5 text-[#7c3aed] hover:text-[#6d28d9] transition-colors font-medium">
            <Image
              src="https://ext.same-assets.com/1985226505/3518235170.svg"
              alt="Help"
              width={16}
              height={16}
            />
